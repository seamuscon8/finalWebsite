...
"[project]/BootCamp/bootcamp-project-2025/milestone-4/src/app/api/blogs/[slug]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req, { params }) {
    ...
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$BootCamp$2f$bootcamp$2d$project$2d$2025$2f$milestone$2d$4$2f$src$2f$database$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(); // function from db.ts before
    const { slug } = await params // another destructure
    ;
    try {
        const blog = await __TURBOPACK__imported__module__$5b$project$5d2f$BootCamp$2f$bootcamp$2d$project$2d$2025$2f$milestone$2d$4$2f$src$2f$database$2f$blogSchema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            slug
        }).lean().orFail();
        return __TURBOPACK__imported__module__$5b$project$5d2f$BootCamp$2f$bootcamp$2d$project$2d$2025$2f$milestone$2d$4$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(blog);
    } catch (err) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$BootCamp$2f$bootcamp$2d$project$2d$2025$2f$milestone$2d$4$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json('Blog not found.', {
            status: 404
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2d97691e._.js.map